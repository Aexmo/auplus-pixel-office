...
ITEMS = [
    ...
    # ---- 第二批 (2026-07-17 Aaron加单) ----
    ('pool_table',    'a green felt pool billiard table with balls and cues, seen from 3/4 top-down game perspective'),
    ('foosball',      'a foosball table soccer game table'),
    ('piano',         'an upright wooden piano with sheet music and bench'),
    ('guitar_stand',  'an acoustic guitar on a wooden stand'),
    ('jukebox',       'a retro jukebox glowing warm neon colors'),
    ('christmas_tree', 'a decorated christmas tree with warm string lights, ornaments and gifts underneath'),
    ('easel',         'a wooden painting easel with a half-finished colorful painting'),
    ('statue',        'a small classical marble statue on a wooden pedestal'),
    ('telescope',     'a brass astronomical telescope on tripod'),
    ('grandfather_clock', 'a tall wooden grandfather clock with pendulum'),
    ('treadmill',     'a home treadmill running machine'),
    ('massage_chair', 'a modern comfortable massage chair'),
    ('reception',     'a wooden reception front desk counter with a small bell and computer'),
    ('sofa_l',        'an L-shaped corner fabric sofa with cushions, seen from 3/4 top-down game perspective'),
    ('wardrobe',      'a tall wooden wardrobe closet with double doors'),
    ('bed_double',    'a cozy double bed with warm blanket and pillows, seen from 3/4 top-down game perspective'),
    ('bunk_bed',      'a wooden bunk bed with ladder'),
    ('washing_machine', 'a white front-loading washing machine'),
    ('popcorn',       'a retro red popcorn machine cart'),
    ('espresso_cart', 'a wooden coffee cart with espresso machine and cups'),
    ('bar_shelf',     'a wooden bar shelf cabinet filled with colorful bottles, wall-standing'),
    ('dog_bed',       'a cozy round dog bed with a sleeping corgi dog'),
    ('pet_bowls',     'a pair of pet food and water bowls on a small mat'),
    ('bird_cage',     'a standing bird cage with a colorful parrot inside'),
    ('flower_vase',   'a large ceramic vase with colorful flowers'),
    ('hanging_plant', 'a hanging basket plant with trailing vines'),
    ('cactus_set',    'a group of three potted cacti of different sizes'),
    ('fountain',      'a small stone garden fountain with water'),
    ('mirror_standing', 'a full-length standing mirror with wooden frame'),
    ('magazine_rack', 'a wooden magazine rack filled with colorful magazines'),
    ('photo_wall',    'a wall photo collage of framed pictures in different sizes, flat front view'),
    ('banner_flag',   'a hanging fabric pennant banner flag, warm colors, flat front view'),
    ('shelf_trophies', 'a wall-mounted shelf with golden trophies and medals, flat front view'),
    ('window_big',    'a large wooden-framed panoramic window showing a sunset mountain view, flat front view'),
    ('rug_rect',      'a rectangular patterned area rug with warm geometric design, seen from directly above'),
    ('welcome_mat',   'a brown doormat with WELCOME woven pattern, seen from directly above'),
]
